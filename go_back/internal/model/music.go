...
type Music struct {
	...
	IsPublic     bool      `gorm:"column:is_public;default:true;not null;index:idx_music_public_order,priority:1" json:"isPublic"`
	DisplayOrder int       `gorm:"column:display_order;default:0;index:idx_music_public_order,priority:2" json:"displayOrder"`
