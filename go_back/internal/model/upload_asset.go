...
type UploadAsset struct {
	...
	Kind      string    `gorm:"column:kind;size:50;not null;index:idx_upload_assets_kind_time,priority:1;index:idx_upload_assets_kind_url,priority:1" json:"kind"`
	Name      string    `gorm:"column:name;size:255;not null" json:"name"`
	URL       string    `gorm:"column:url;size:1000;not null;uniqueIndex;index:idx_upload_assets_kind_url,priority:2" json:"url"`
