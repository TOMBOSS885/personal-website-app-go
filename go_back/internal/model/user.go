...
type User struct {
	...
	PasswordConfigured  bool       `gorm:"column:password_configured;default:false;not null" json:"passwordConfigured"`
	...
	EmailVerified       bool       `gorm:"column:email_verified;default:false;not null" json:"emailVerified"`
	Status              string     `gorm:"column:status;size:20;default:active;not null;index" json:"status"`
	TokenVersion        uint64     `gorm:"column:token_version;default:1;not null" json:"-"`
	LoginCount          uint64     `gorm:"column:login_count;default:0;not null" json:"loginCount"`
	FailedLoginAttempts int        `gorm:"column:failed_login_attempts;default:0;not null" json:"failedLoginAttempts"`
	LoginLockedUntil    *time.Time `gorm:"column:login_locked_until;index" json:"loginLockedUntil"`
