...
function findLegacyBlockEnd(lines, startIndex) {
...
function normalizeLegacyMathBody(lines) {
...
function replaceInlineDelimitersOutsideCode(line) {
  let cursor = 0
  let output = ''
...
function replaceInlineDelimiters(value) {
  return value
